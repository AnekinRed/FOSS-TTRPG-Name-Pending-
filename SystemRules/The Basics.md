...
*We will go more into detail on how to start, run, and end a Campaign after we've laid out the ground-works for the system rules, and mechanics. Or you can skip ahead to that part in [How to run a Campaign](/SystemRules/GMsGuide/How%20to%20run%20a%20Campaign.md)*
